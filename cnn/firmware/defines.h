...
typedef nnet::array<ap_ufixed<5,1,AP_RND_CONV,AP_SAT>, 16*1> layer3_t;
...
typedef nnet::array<ap_ufixed<5,1,AP_RND_CONV,AP_SAT>, 32*1> layer6_t;
...
typedef nnet::array<ap_ufixed<5,1,AP_RND_CONV,AP_SAT>, 64*1> layer9_t;
...
typedef nnet::array<ap_ufixed<5,0,AP_RND_CONV,AP_SAT>, 1*1> result_t;
